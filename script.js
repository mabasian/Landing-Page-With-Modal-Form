...
signupX.addEventListener("mouseover", () => {
  signupX.classList.add("spin");
});

signupX.addEventListener("mouseout", () => {
  signupX.classList.remove("spin");
});

loginX.addEventListener("mouseover", () => {
  loginX.classList.add("spin");
});

loginX.addEventListener("mouseout", () => {
  loginX.classList.remove("spin");
});
